...
Сравнение разных комбинаций TP и SL
"""
import sys
import os
...
test_variants = [
    {'tp': 0.5, 'sl': 1.0, 'name': 'Вариант 1 (Агрессивный)'},
    {'tp': 0.6, 'sl': 1.0, 'name': 'Вариант 2 (Сбалансированный)'},
    {'tp': 0.7, 'sl': 1.0, 'name': 'Вариант 3 (Консервативный)'},
]
